...
class Model(BaseModel):
    ...
    def __init__(self, config):
        ...
        self.base_model = keras.applications.InceptionV3(weights='weights/inception_v3_weights_tf_dim_ordering_tf_kernels_notop.h5',
                        include_top=False,
    ...
    def train(self):
        ...
        """
        self.model.compile(optimizer=keras.optimizers.SGD(lr=0.0001, momentum=0.9), 
               loss='categorical_crossentropy', 
               metrics=[tf.keras.metrics.TopKCategoricalAccuracy(k = 1)])

        checkpointer = keras.callbacks.ModelCheckpoint(filepath='weights.best.inc.blond.hdf5', 
        ...
        model_history = self.model.fit(self.train_generator,
                                        ...
                                        callbacks=[checkpointer, wandb.keras.WandbCallback(data_type="image", save_model=True)], 
                                        verbose=1)
